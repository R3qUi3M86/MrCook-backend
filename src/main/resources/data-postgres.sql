...
VALUES ('anonymous', 'anonymous', false, 'CUSTOMER', 'anonymous');
INSERT INTO public.user(email, password, member, roles, username, fk_product_comment)
VALUES ('admin@mrcook.com', '$2a$10$LE54lCyt.tYMV9uc76ZcteF9dz4djZaeGmYEW4W94A6v0cfMluBe.', true, 'ADMIN', 'mr-cook', 1);
INSERT INTO public.user(email, password, member, roles, username, fk_product_comment)
VALUES ('stiepan@mrcook.com', '$2a$10$L7HyGwkLYSjfOx5l3v2APOxcUSCEHBmYC5K5p1o4f.BWkuRZWCFEu', true, 'CUSTOMER', 'stiepan', 2);
INSERT INTO public.user(email, password, member, roles, username)
VALUES ('marian@mrcook.com', '$2a$10$VdafmUqtmK.MRl.s9z7Gse3DOWD4E9l6pSILA.FolPB0887cS4Uyq', true, 'CUSTOMER', 'marian');
