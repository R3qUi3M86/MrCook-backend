...
INSERT INTO public.user(email, password, roles, username, fk_product_comment)
VALUES ('admin@mrcook.com', 'pass', 'ADMIN', 'mr-cook', 1);
INSERT INTO public.user(email, password, roles, username, fk_product_comment)
VALUES ('stiepan@mrcook.com', 'pass2', 'CUSTOMER', 'stiepan', 2);
